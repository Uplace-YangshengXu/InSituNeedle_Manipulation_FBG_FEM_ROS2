...
static const _FindNorm_Request_type_support_symbol_names_t _FindNorm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment1_msgs, srv, FindNorm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment1_msgs, srv, FindNorm_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, assignment1_msgs, srv, FindNorm_Request)() {
  return &::assignment1_msgs::srv::rosidl_typesupport_c::FindNorm_Request_message_type_support_handle;
}
...
static const _FindNorm_Response_type_support_symbol_names_t _FindNorm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment1_msgs, srv, FindNorm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment1_msgs, srv, FindNorm_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_assignment1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, assignment1_msgs, srv, FindNorm_Response)() {
  return &::assignment1_msgs::srv::rosidl_typesupport_c::FindNorm_Response_message_type_support_handle;
}
...
static const _FindNorm_type_support_symbol_names_t _FindNorm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment1_msgs, srv, FindNorm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment1_msgs, srv, FindNorm)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, assignment1_msgs, srv, FindNorm)() {
  return &::assignment1_msgs::srv::rosidl_typesupport_c::FindNorm_service_type_support_handle;
}
