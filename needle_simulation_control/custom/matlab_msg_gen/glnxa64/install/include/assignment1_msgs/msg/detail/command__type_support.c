...
#include <stddef.h>
#include "assignment1_msgs/msg/detail/command__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  assignment1_msgs__msg__Command__init(message_memory);
}

void Command__rosidl_typesupport_introspection_c__Command_fini_function(void * message_memory)
{
  assignment1_msgs__msg__Command__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Command__rosidl_typesupport_introspection_c__Command_message_member_array[1] = {
  {
    "name",  // name
    ...
    offsetof(assignment1_msgs__msg__Command, name),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Command__rosidl_typesupport_introspection_c__Command_message_members = {
  ...
  1,  // number of fields
  sizeof(assignment1_msgs__msg__Command),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment1_msgs, msg, Command)() {
