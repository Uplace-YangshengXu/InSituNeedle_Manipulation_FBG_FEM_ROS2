function [x_new, y_new, k_new, curvatures] = planar_needle_FEM_debug(L, Mu, Alpha, Interval, ...
    x_pre, y_pre, k_pre, ...
    dbx, dby, dbk, ...
    AA_lcn)
...
while converged == 0 && (outer_iter < max_outer_iter)
    ...
    while inner_iter < max_inner_iter
        ...
        for e = 1:Nel
            ...
            [ke, pe] = compute_element_matrix(d_i_local, ti, E, I, [], h, ...
                MuTs(e), AlphaTs(e), GammaTs(e), [], []);
