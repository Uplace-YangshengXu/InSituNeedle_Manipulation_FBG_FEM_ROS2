...
#include "assignment1_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
using _Command__ros_msg_type = assignment1_msgs__msg__Command;
...
size_t get_serialized_size_assignment1_msgs__msg__Command(
  const void * untyped_ros_message,
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_assignment1_msgs__msg__Command(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_assignment1_msgs
size_t max_serialized_size_assignment1_msgs__msg__Command(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_assignment1_msgs__msg__Command(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Command = {
  "assignment1_msgs::msg",
  "Command",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment1_msgs, msg, Command)() {
