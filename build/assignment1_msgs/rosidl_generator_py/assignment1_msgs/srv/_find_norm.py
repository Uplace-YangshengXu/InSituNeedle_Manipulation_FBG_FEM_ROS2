...
class Metaclass_FindNorm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from assignment1_msgs.srv import _find_norm
...
class FindNorm(metaclass=Metaclass_FindNorm):
    from assignment1_msgs.srv._find_norm import FindNorm_Request as Request
    from assignment1_msgs.srv._find_norm import FindNorm_Response as Response
