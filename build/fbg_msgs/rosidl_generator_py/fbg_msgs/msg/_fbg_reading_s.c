...
bool fbg_msgs__msg__fbg_reading__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // signal_reading
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->signal_reading.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'signal_reading'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FbgReading */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fbg_msgs.msg._fbg_reading");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FbgReading");
  ...
  {  // signal_reading
    ...
    if (ros_message->signal_reading.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->signal_reading.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->signal_reading.size * sizeof(double));
      assert(data != NULL);
