...
void FbgReading__rosidl_typesupport_introspection_c__FbgReading_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  fbg_msgs__msg__FbgReading__init(message_memory);
}

void FbgReading__rosidl_typesupport_introspection_c__FbgReading_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_member_array[3] = {
  {
    ...
    offsetof(fbg_msgs__msg__FbgReading, signal_reading),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(fbg_msgs__msg__FbgReading, signal_each_ch),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fbg_msgs__msg__FbgReading, total_reading_num),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_members = {
  ...
  FbgReading__rosidl_typesupport_introspection_c__FbgReading_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_type_support_handle = {
  0,
  &FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fbg_msgs, msg, FbgReading)() {
  if (!FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_type_support_handle.typesupport_identifier) {
    FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &FbgReading__rosidl_typesupport_introspection_c__FbgReading_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
